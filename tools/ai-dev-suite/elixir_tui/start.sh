...
echo ""
echo -e "${RED}●${RESET} ${RED}Zerwiz AI${RESET} ${WHITE}Dev Suite${RESET} TUI – WhyNot Productions"
...
# Fetch deps and run
echo -e "${DIM}Starting Zerwiz AI Dev Suite TUI...${RESET}"
echo ""
mix deps.get 2>/dev/null || true
mix run -e "AiDevSuiteTui.CLI.main([])"
