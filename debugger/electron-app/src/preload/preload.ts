...
contextBridge.exposeInMainWorld('debugApi', {
  ...
  getSuitePreferredModel: () => ipcRenderer.invoke('debug:getSuitePreferredModel'),
  getDownloadableModels: () => ipcRenderer.invoke('debug:getDownloadableModels'),
  pullModel: (name: string) => ipcRenderer.invoke('debug:pullModel', name),
