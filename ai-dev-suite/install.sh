#!/usr/bin/env bash
# AI Dev Suite – WhyNot Productions
...
# Install Ollama: curl -fsSL ... | bash -s ollama
...
# Header
printf "\n"
printf "  ${RED}●${RESET} ${WHITE}AI Dev Suite${RESET}\n"
...
printf "${DIM}Or: curl ... | bash -s ollama  to install directly.${RESET}\n"
